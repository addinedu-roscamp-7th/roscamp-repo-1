...
{
  new (message_memory) shopee_interfaces::msg::BBox(_init);
}

void BBox_fini_function(void * message_memory)
{
  auto typed_message = static_cast<shopee_interfaces::msg::BBox *>(message_memory);
  typed_message->~BBox();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember BBox_message_member_array[4] = {
  {
    "x1",  // name
    ...
    offsetof(shopee_interfaces::msg::BBox, x1),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(shopee_interfaces::msg::BBox, y1),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(shopee_interfaces::msg::BBox, x2),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(shopee_interfaces::msg::BBox, y2),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers BBox_message_members = {
  ...
  "BBox",  // message name
  4,  // number of fields
  sizeof(shopee_interfaces::msg::BBox),
...
get_message_type_support_handle<shopee_interfaces::msg::BBox>()
{
  return &::shopee_interfaces::msg::rosidl_typesupport_introspection_cpp::BBox_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, shopee_interfaces, msg, BBox)() {
  return &::shopee_interfaces::msg::rosidl_typesupport_introspection_cpp::BBox_message_type_support_handle;
}
