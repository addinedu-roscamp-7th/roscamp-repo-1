...
{
  new (message_memory) shopee_interfaces::msg::Vector2D(_init);
}

void Vector2D_fini_function(void * message_memory)
{
  auto typed_message = static_cast<shopee_interfaces::msg::Vector2D *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Vector2D_message_member_array[2] = {
  {
    ...
    offsetof(shopee_interfaces::msg::Vector2D, vx),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(shopee_interfaces::msg::Vector2D, vy),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Vector2D_message_members = {
  ...
  2,  // number of fields
  sizeof(shopee_interfaces::msg::Vector2D),
...
{
  return &::shopee_interfaces::msg::rosidl_typesupport_introspection_cpp::Vector2D_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, shopee_interfaces, msg, Vector2D)() {
  return &::shopee_interfaces::msg::rosidl_typesupport_introspection_cpp::Vector2D_message_type_support_handle;
}
