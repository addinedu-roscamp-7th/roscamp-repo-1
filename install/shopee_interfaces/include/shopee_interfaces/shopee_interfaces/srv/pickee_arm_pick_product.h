...
#ifndef SHOPEE_INTERFACES__SRV__PICKEE_ARM_PICK_PRODUCT_H_
#define SHOPEE_INTERFACES__SRV__PICKEE_ARM_PICK_PRODUCT_H_
...
#endif  // SHOPEE_INTERFACES__SRV__PICKEE_ARM_PICK_PRODUCT_H_
