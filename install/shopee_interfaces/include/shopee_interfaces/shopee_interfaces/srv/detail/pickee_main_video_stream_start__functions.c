...
shopee_interfaces__srv__PickeeMainVideoStreamStart_Request__init(shopee_interfaces__srv__PickeeMainVideoStreamStart_Request * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->user_type)) {
    shopee_interfaces__srv__PickeeMainVideoStreamStart_Request__fini(msg);
    return false;
  }
  // user_id
...
shopee_interfaces__srv__PickeeMainVideoStreamStart_Request__create(void)
{
  ...
  shopee_interfaces__srv__PickeeMainVideoStreamStart_Request * msg = (shopee_interfaces__srv__PickeeMainVideoStreamStart_Request *)allocator.allocate(sizeof(shopee_interfaces__srv__PickeeMainVideoStreamStart_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(shopee_interfaces__srv__PickeeMainVideoStreamStart_Request));
  bool success = shopee_interfaces__srv__PickeeMainVideoStreamStart_Request__init(msg);
  if (!success) {
...
shopee_interfaces__srv__PickeeMainVideoStreamStart_Request__Sequence__init(shopee_interfaces__srv__PickeeMainVideoStreamStart_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  shopee_interfaces__srv__PickeeMainVideoStreamStart_Request * data = NULL;

  if (size) {
    data = (shopee_interfaces__srv__PickeeMainVideoStreamStart_Request *)allocator.zero_allocate(size, sizeof(shopee_interfaces__srv__PickeeMainVideoStreamStart_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = shopee_interfaces__srv__PickeeMainVideoStreamStart_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        shopee_interfaces__srv__PickeeMainVideoStreamStart_Request__fini(&data[i - 1]);
      }
...
shopee_interfaces__srv__PickeeMainVideoStreamStart_Request__Sequence__fini(shopee_interfaces__srv__PickeeMainVideoStreamStart_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      shopee_interfaces__srv__PickeeMainVideoStreamStart_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  shopee_interfaces__srv__PickeeMainVideoStreamStart_Request__Sequence * array = (shopee_interfaces__srv__PickeeMainVideoStreamStart_Request__Sequence *)allocator.allocate(sizeof(shopee_interfaces__srv__PickeeMainVideoStreamStart_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = shopee_interfaces__srv__PickeeMainVideoStreamStart_Request__Sequence__init(array, size);
  if (!success) {
...
shopee_interfaces__srv__PickeeMainVideoStreamStart_Request__Sequence__destroy(shopee_interfaces__srv__PickeeMainVideoStreamStart_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    shopee_interfaces__srv__PickeeMainVideoStreamStart_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
shopee_interfaces__srv__PickeeMainVideoStreamStart_Request__Sequence__are_equal(const shopee_interfaces__srv__PickeeMainVideoStreamStart_Request__Sequence * lhs, const shopee_interfaces__srv__PickeeMainVideoStreamStart_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!shopee_interfaces__srv__PickeeMainVideoStreamStart_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  shopee_interfaces__srv__PickeeMainVideoStreamStart_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(shopee_interfaces__srv__PickeeMainVideoStreamStart_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    shopee_interfaces__srv__PickeeMainVideoStreamStart_Request * data =
      (shopee_interfaces__srv__PickeeMainVideoStreamStart_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!shopee_interfaces__srv__PickeeMainVideoStreamStart_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          shopee_interfaces__srv__PickeeMainVideoStreamStart_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!shopee_interfaces__srv__PickeeMainVideoStreamStart_Request__copy(
...
shopee_interfaces__srv__PickeeMainVideoStreamStart_Response__init(shopee_interfaces__srv__PickeeMainVideoStreamStart_Response * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->message)) {
    shopee_interfaces__srv__PickeeMainVideoStreamStart_Response__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  shopee_interfaces__srv__PickeeMainVideoStreamStart_Response * msg = (shopee_interfaces__srv__PickeeMainVideoStreamStart_Response *)allocator.allocate(sizeof(shopee_interfaces__srv__PickeeMainVideoStreamStart_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(shopee_interfaces__srv__PickeeMainVideoStreamStart_Response));
  bool success = shopee_interfaces__srv__PickeeMainVideoStreamStart_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
shopee_interfaces__srv__PickeeMainVideoStreamStart_Response__Sequence__init(shopee_interfaces__srv__PickeeMainVideoStreamStart_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  shopee_interfaces__srv__PickeeMainVideoStreamStart_Response * data = NULL;

  if (size) {
    data = (shopee_interfaces__srv__PickeeMainVideoStreamStart_Response *)allocator.zero_allocate(size, sizeof(shopee_interfaces__srv__PickeeMainVideoStreamStart_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = shopee_interfaces__srv__PickeeMainVideoStreamStart_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        shopee_interfaces__srv__PickeeMainVideoStreamStart_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
shopee_interfaces__srv__PickeeMainVideoStreamStart_Response__Sequence__fini(shopee_interfaces__srv__PickeeMainVideoStreamStart_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      shopee_interfaces__srv__PickeeMainVideoStreamStart_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  shopee_interfaces__srv__PickeeMainVideoStreamStart_Response__Sequence * array = (shopee_interfaces__srv__PickeeMainVideoStreamStart_Response__Sequence *)allocator.allocate(sizeof(shopee_interfaces__srv__PickeeMainVideoStreamStart_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = shopee_interfaces__srv__PickeeMainVideoStreamStart_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
shopee_interfaces__srv__PickeeMainVideoStreamStart_Response__Sequence__destroy(shopee_interfaces__srv__PickeeMainVideoStreamStart_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    shopee_interfaces__srv__PickeeMainVideoStreamStart_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
shopee_interfaces__srv__PickeeMainVideoStreamStart_Response__Sequence__are_equal(const shopee_interfaces__srv__PickeeMainVideoStreamStart_Response__Sequence * lhs, const shopee_interfaces__srv__PickeeMainVideoStreamStart_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!shopee_interfaces__srv__PickeeMainVideoStreamStart_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  shopee_interfaces__srv__PickeeMainVideoStreamStart_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(shopee_interfaces__srv__PickeeMainVideoStreamStart_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    shopee_interfaces__srv__PickeeMainVideoStreamStart_Response * data =
      (shopee_interfaces__srv__PickeeMainVideoStreamStart_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!shopee_interfaces__srv__PickeeMainVideoStreamStart_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          shopee_interfaces__srv__PickeeMainVideoStreamStart_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!shopee_interfaces__srv__PickeeMainVideoStreamStart_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
shopee_interfaces__srv__PickeeMainVideoStreamStart_Event__init(shopee_interfaces__srv__PickeeMainVideoStreamStart_Event * msg)
{
  ...
  if (!service_msgs__msg__ServiceEventInfo__init(&msg->info)) {
    shopee_interfaces__srv__PickeeMainVideoStreamStart_Event__fini(msg);
    return false;
  }
  // request
  if (!shopee_interfaces__srv__PickeeMainVideoStreamStart_Request__Sequence__init(&msg->request, 0)) {
    shopee_interfaces__srv__PickeeMainVideoStreamStart_Event__fini(msg);
    return false;
  }
  // response
  if (!shopee_interfaces__srv__PickeeMainVideoStreamStart_Response__Sequence__init(&msg->response, 0)) {
    shopee_interfaces__srv__PickeeMainVideoStreamStart_Event__fini(msg);
    return false;
  }
  return true;
...
shopee_interfaces__srv__PickeeMainVideoStreamStart_Event__fini(shopee_interfaces__srv__PickeeMainVideoStreamStart_Event * msg)
{
  ...
  // request
  shopee_interfaces__srv__PickeeMainVideoStreamStart_Request__Sequence__fini(&msg->request);
  // response
  shopee_interfaces__srv__PickeeMainVideoStreamStart_Response__Sequence__fini(&msg->response);
}
...
shopee_interfaces__srv__PickeeMainVideoStreamStart_Event__are_equal(const shopee_interfaces__srv__PickeeMainVideoStreamStart_Event * lhs, const shopee_interfaces__srv__PickeeMainVideoStreamStart_Event * rhs)
{
  ...
  // request
  if (!shopee_interfaces__srv__PickeeMainVideoStreamStart_Request__Sequence__are_equal(
      &(lhs->request), &(rhs->request)))
  {
    return false;
  }
  // response
  if (!shopee_interfaces__srv__PickeeMainVideoStreamStart_Response__Sequence__are_equal(
  ...
  shopee_interfaces__srv__PickeeMainVideoStreamStart_Event * output)
{
  ...
  // request
  if (!shopee_interfaces__srv__PickeeMainVideoStreamStart_Request__Sequence__copy(
      &(input->request), &(output->request)))
  {
    return false;
  }
  // response
  if (!shopee_interfaces__srv__PickeeMainVideoStreamStart_Response__Sequence__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  shopee_interfaces__srv__PickeeMainVideoStreamStart_Event * msg = (shopee_interfaces__srv__PickeeMainVideoStreamStart_Event *)allocator.allocate(sizeof(shopee_interfaces__srv__PickeeMainVideoStreamStart_Event), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(shopee_interfaces__srv__PickeeMainVideoStreamStart_Event));
  bool success = shopee_interfaces__srv__PickeeMainVideoStreamStart_Event__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
shopee_interfaces__srv__PickeeMainVideoStreamStart_Event__Sequence__init(shopee_interfaces__srv__PickeeMainVideoStreamStart_Event__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  shopee_interfaces__srv__PickeeMainVideoStreamStart_Event * data = NULL;

  if (size) {
    data = (shopee_interfaces__srv__PickeeMainVideoStreamStart_Event *)allocator.zero_allocate(size, sizeof(shopee_interfaces__srv__PickeeMainVideoStreamStart_Event), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = shopee_interfaces__srv__PickeeMainVideoStreamStart_Event__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        shopee_interfaces__srv__PickeeMainVideoStreamStart_Event__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
shopee_interfaces__srv__PickeeMainVideoStreamStart_Event__Sequence__fini(shopee_interfaces__srv__PickeeMainVideoStreamStart_Event__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      shopee_interfaces__srv__PickeeMainVideoStreamStart_Event__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  shopee_interfaces__srv__PickeeMainVideoStreamStart_Event__Sequence * array = (shopee_interfaces__srv__PickeeMainVideoStreamStart_Event__Sequence *)allocator.allocate(sizeof(shopee_interfaces__srv__PickeeMainVideoStreamStart_Event__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = shopee_interfaces__srv__PickeeMainVideoStreamStart_Event__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
shopee_interfaces__srv__PickeeMainVideoStreamStart_Event__Sequence__destroy(shopee_interfaces__srv__PickeeMainVideoStreamStart_Event__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    shopee_interfaces__srv__PickeeMainVideoStreamStart_Event__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
shopee_interfaces__srv__PickeeMainVideoStreamStart_Event__Sequence__are_equal(const shopee_interfaces__srv__PickeeMainVideoStreamStart_Event__Sequence * lhs, const shopee_interfaces__srv__PickeeMainVideoStreamStart_Event__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!shopee_interfaces__srv__PickeeMainVideoStreamStart_Event__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  shopee_interfaces__srv__PickeeMainVideoStreamStart_Event__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(shopee_interfaces__srv__PickeeMainVideoStreamStart_Event);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    shopee_interfaces__srv__PickeeMainVideoStreamStart_Event * data =
      (shopee_interfaces__srv__PickeeMainVideoStreamStart_Event *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!shopee_interfaces__srv__PickeeMainVideoStreamStart_Event__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          shopee_interfaces__srv__PickeeMainVideoStreamStart_Event__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!shopee_interfaces__srv__PickeeMainVideoStreamStart_Event__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
