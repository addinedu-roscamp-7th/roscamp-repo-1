...
bool shopee_interfaces__msg__b_box__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("shopee_interfaces.msg._b_box.BBox", full_classname_dest, 33) == 0);
  }
  shopee_interfaces__msg__BBox * ros_message = _ros_message;
  {  // x1
...
PyObject * shopee_interfaces__msg__b_box__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("shopee_interfaces.msg._b_box");
