...
bool shopee_interfaces__msg__point2_d__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("shopee_interfaces.msg._point2_d.Point2D", full_classname_dest, 39) == 0);
  }
  shopee_interfaces__msg__Point2D * ros_message = _ros_message;
  {  // x
...
PyObject * shopee_interfaces__msg__point2_d__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("shopee_interfaces.msg._point2_d");
