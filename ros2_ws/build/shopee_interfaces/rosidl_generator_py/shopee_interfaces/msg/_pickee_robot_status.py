...
class Metaclass_PickeeRobotStatus(type):
    """Metaclass of message 'PickeeRobotStatus'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'shopee_interfaces.msg.PickeeRobotStatus')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__pickee_robot_status
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__pickee_robot_status
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__pickee_robot_status
            cls._TYPE_SUPPORT = module.type_support_msg__msg__pickee_robot_status
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__pickee_robot_status
...
class PickeeRobotStatus(metaclass=Metaclass_PickeeRobotStatus):
    """Message class 'PickeeRobotStatus'."""
    ...
    def orientation_z(self, value):
        if self._check_fields:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'orientation_z' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
