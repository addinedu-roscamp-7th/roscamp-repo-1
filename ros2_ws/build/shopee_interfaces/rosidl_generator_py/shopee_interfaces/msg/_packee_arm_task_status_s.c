...
bool shopee_interfaces__msg__packee_arm_task_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("shopee_interfaces.msg._packee_arm_task_status.PackeeArmTaskStatus", full_classname_dest, 65) == 0);
  }
  shopee_interfaces__msg__PackeeArmTaskStatus * ros_message = _ros_message;
  {  // robot_id
...
{
  /* NOTE(esteve): Call constructor of PackeeArmTaskStatus */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("shopee_interfaces.msg._packee_arm_task_status");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "PackeeArmTaskStatus");
