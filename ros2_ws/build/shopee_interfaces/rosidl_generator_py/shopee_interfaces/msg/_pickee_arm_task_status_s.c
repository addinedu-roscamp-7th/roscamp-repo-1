...
bool shopee_interfaces__msg__pickee_arm_task_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("shopee_interfaces.msg._pickee_arm_task_status.PickeeArmTaskStatus", full_classname_dest, 65) == 0);
  }
  shopee_interfaces__msg__PickeeArmTaskStatus * ros_message = _ros_message;
  {  // robot_id
...
{
  /* NOTE(esteve): Call constructor of PickeeArmTaskStatus */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("shopee_interfaces.msg._pickee_arm_task_status");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "PickeeArmTaskStatus");
