...
#include "shopee_interfaces/msg/detail/b_box__rosidl_typesupport_fastrtps_c.h"
...
using _BBox__ros_msg_type = shopee_interfaces__msg__BBox;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = shopee_interfaces__msg__BBox;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const shopee_interfaces__msg__BBox * ros_message = static_cast<const shopee_interfaces__msg__BBox *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_shopee_interfaces__msg__BBox(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  shopee_interfaces__msg__BBox * ros_message = static_cast<shopee_interfaces__msg__BBox *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_shopee_interfaces__msg__BBox(cdr, ros_message);
}

static uint32_t _BBox__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_shopee_interfaces__msg__BBox(
...
static size_t _BBox__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_shopee_interfaces__msg__BBox(
