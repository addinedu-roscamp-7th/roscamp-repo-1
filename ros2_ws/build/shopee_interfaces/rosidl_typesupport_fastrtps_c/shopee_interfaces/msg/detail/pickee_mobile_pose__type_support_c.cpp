...
#include "shopee_interfaces/msg/detail/pickee_mobile_pose__rosidl_typesupport_fastrtps_c.h"
...
#include "shopee_interfaces/msg/detail/pose2_d__functions.h"  // current_pose
...
using _PickeeMobilePose__ros_msg_type = shopee_interfaces__msg__PickeeMobilePose;


ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_shopee_interfaces
bool cdr_serialize_shopee_interfaces__msg__PickeeMobilePose(
  const shopee_interfaces__msg__PickeeMobilePose * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: robot_id
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_shopee_interfaces
bool cdr_deserialize_shopee_interfaces__msg__PickeeMobilePose(
  eprosima::fastcdr::Cdr & cdr,
  shopee_interfaces__msg__PickeeMobilePose * ros_message)
{
  // Field name: robot_id
  {
    cdr >> ros_message->robot_id;
  ...
  // Field name: current_pose
  {
    cdr_deserialize_shopee_interfaces__msg__Pose2D(cdr, &ros_message->current_pose);
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_shopee_interfaces
size_t get_serialized_size_shopee_interfaces__msg__PickeeMobilePose(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _PickeeMobilePose__ros_msg_type * ros_message = static_cast<const _PickeeMobilePose__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_shopee_interfaces
size_t max_serialized_size_shopee_interfaces__msg__PickeeMobilePose(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = shopee_interfaces__msg__PickeeMobilePose;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_shopee_interfaces
bool cdr_serialize_key_shopee_interfaces__msg__PickeeMobilePose(
  const shopee_interfaces__msg__PickeeMobilePose * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: robot_id
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_shopee_interfaces
size_t get_serialized_size_key_shopee_interfaces__msg__PickeeMobilePose(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _PickeeMobilePose__ros_msg_type * ros_message = static_cast<const _PickeeMobilePose__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_shopee_interfaces
size_t max_serialized_size_key_shopee_interfaces__msg__PickeeMobilePose(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const shopee_interfaces__msg__PickeeMobilePose * ros_message = static_cast<const shopee_interfaces__msg__PickeeMobilePose *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_shopee_interfaces__msg__PickeeMobilePose(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  shopee_interfaces__msg__PickeeMobilePose * ros_message = static_cast<shopee_interfaces__msg__PickeeMobilePose *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_shopee_interfaces__msg__PickeeMobilePose(cdr, ros_message);
}

static uint32_t _PickeeMobilePose__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_shopee_interfaces__msg__PickeeMobilePose(
...
static size_t _PickeeMobilePose__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_shopee_interfaces__msg__PickeeMobilePose(
...
static message_type_support_callbacks_t __callbacks_PickeeMobilePose = {
...
static rosidl_message_type_support_t _PickeeMobilePose__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_PickeeMobilePose,
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, shopee_interfaces, msg, PickeeMobilePose)() {
  return &_PickeeMobilePose__type_support;
}
