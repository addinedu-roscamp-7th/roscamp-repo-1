...
#include "shopee_interfaces/msg/detail/pickee_mobile_speed_control__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // reason, speed_mode
#include "rosidl_runtime_c/string_functions.h"  // reason, speed_mode
...
using _PickeeMobileSpeedControl__ros_msg_type = shopee_interfaces__msg__PickeeMobileSpeedControl;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: speed_mode
  {
    const rosidl_runtime_c__String * str = &ros_message->speed_mode;
  ...
  shopee_interfaces__msg__PickeeMobileSpeedControl * ros_message)
{
  ...
  // Field name: speed_mode
  {
    std::string tmp;
    cdr >> tmp;
    if (!ros_message->speed_mode.data) {
      rosidl_runtime_c__String__init(&ros_message->speed_mode);
    }
    bool succeeded = rosidl_runtime_c__String__assign(
      &ros_message->speed_mode,
      tmp.c_str());
    if (!succeeded) {
      fprintf(stderr, "failed to assign string into field 'speed_mode'\n");
      return false;
    }
  }
...
size_t get_serialized_size_shopee_interfaces__msg__PickeeMobileSpeedControl(
  ...
  size_t current_alignment)
{
  const _PickeeMobileSpeedControl__ros_msg_type * ros_message = static_cast<const _PickeeMobileSpeedControl__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = shopee_interfaces__msg__PickeeMobileSpeedControl;
    is_plain =
      (
...
static bool _PickeeMobileSpeedControl__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const shopee_interfaces__msg__PickeeMobileSpeedControl * ros_message = static_cast<const shopee_interfaces__msg__PickeeMobileSpeedControl *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_shopee_interfaces__msg__PickeeMobileSpeedControl(ros_message, cdr);
}

static bool _PickeeMobileSpeedControl__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  shopee_interfaces__msg__PickeeMobileSpeedControl * ros_message = static_cast<shopee_interfaces__msg__PickeeMobileSpeedControl *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_shopee_interfaces__msg__PickeeMobileSpeedControl(cdr, ros_message);
}

static uint32_t _PickeeMobileSpeedControl__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_shopee_interfaces__msg__PickeeMobileSpeedControl(
      untyped_ros_message, 0));
}

static size_t _PickeeMobileSpeedControl__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_shopee_interfaces__msg__PickeeMobileSpeedControl(
...
static message_type_support_callbacks_t __callbacks_PickeeMobileSpeedControl = {
  "shopee_interfaces::msg",
  "PickeeMobileSpeedControl",
  _PickeeMobileSpeedControl__cdr_serialize,
  _PickeeMobileSpeedControl__cdr_deserialize,
  _PickeeMobileSpeedControl__get_serialized_size,
  _PickeeMobileSpeedControl__max_serialized_size,
  nullptr
};

static rosidl_message_type_support_t _PickeeMobileSpeedControl__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_PickeeMobileSpeedControl,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, shopee_interfaces, msg, PickeeMobileSpeedControl)() {
  return &_PickeeMobileSpeedControl__type_support;
}
