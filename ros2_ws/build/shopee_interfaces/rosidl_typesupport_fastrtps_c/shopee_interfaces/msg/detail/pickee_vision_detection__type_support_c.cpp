...
#include "shopee_interfaces/msg/detail/pickee_vision_detection__rosidl_typesupport_fastrtps_c.h"
...
using _PickeeVisionDetection__ros_msg_type = shopee_interfaces__msg__PickeeVisionDetection;


ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_shopee_interfaces
bool cdr_serialize_shopee_interfaces__msg__PickeeVisionDetection(
  const shopee_interfaces__msg__PickeeVisionDetection * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: robot_id
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_shopee_interfaces
bool cdr_deserialize_shopee_interfaces__msg__PickeeVisionDetection(
  eprosima::fastcdr::Cdr & cdr,
  shopee_interfaces__msg__PickeeVisionDetection * ros_message)
{
  // Field name: robot_id
  {
    cdr >> ros_message->robot_id;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_shopee_interfaces
size_t get_serialized_size_shopee_interfaces__msg__PickeeVisionDetection(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _PickeeVisionDetection__ros_msg_type * ros_message = static_cast<const _PickeeVisionDetection__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_shopee_interfaces
size_t max_serialized_size_shopee_interfaces__msg__PickeeVisionDetection(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = shopee_interfaces__msg__PickeeVisionDetection;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_shopee_interfaces
bool cdr_serialize_key_shopee_interfaces__msg__PickeeVisionDetection(
  const shopee_interfaces__msg__PickeeVisionDetection * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: robot_id
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_shopee_interfaces
size_t get_serialized_size_key_shopee_interfaces__msg__PickeeVisionDetection(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _PickeeVisionDetection__ros_msg_type * ros_message = static_cast<const _PickeeVisionDetection__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_shopee_interfaces
size_t max_serialized_size_key_shopee_interfaces__msg__PickeeVisionDetection(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static bool _PickeeVisionDetection__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const shopee_interfaces__msg__PickeeVisionDetection * ros_message = static_cast<const shopee_interfaces__msg__PickeeVisionDetection *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_shopee_interfaces__msg__PickeeVisionDetection(ros_message, cdr);
}

static bool _PickeeVisionDetection__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  shopee_interfaces__msg__PickeeVisionDetection * ros_message = static_cast<shopee_interfaces__msg__PickeeVisionDetection *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_shopee_interfaces__msg__PickeeVisionDetection(cdr, ros_message);
}

static uint32_t _PickeeVisionDetection__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_shopee_interfaces__msg__PickeeVisionDetection(
      untyped_ros_message, 0));
}

static size_t _PickeeVisionDetection__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_shopee_interfaces__msg__PickeeVisionDetection(
...
static message_type_support_callbacks_t __callbacks_PickeeVisionDetection = {
  "shopee_interfaces::msg",
  "PickeeVisionDetection",
  _PickeeVisionDetection__cdr_serialize,
  _PickeeVisionDetection__cdr_deserialize,
  _PickeeVisionDetection__get_serialized_size,
  _PickeeVisionDetection__max_serialized_size,
  nullptr
};

static rosidl_message_type_support_t _PickeeVisionDetection__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_PickeeVisionDetection,
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, shopee_interfaces, msg, PickeeVisionDetection)() {
  return &_PickeeVisionDetection__type_support;
}
