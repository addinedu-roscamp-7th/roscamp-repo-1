...
static const _PackeeArmTaskStatus_type_support_symbol_names_t _PackeeArmTaskStatus_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, shopee_interfaces, msg, PackeeArmTaskStatus)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, shopee_interfaces, msg, PackeeArmTaskStatus)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, shopee_interfaces, msg, PackeeArmTaskStatus)() {
  return &::shopee_interfaces::msg::rosidl_typesupport_c::PackeeArmTaskStatus_message_type_support_handle;
}
