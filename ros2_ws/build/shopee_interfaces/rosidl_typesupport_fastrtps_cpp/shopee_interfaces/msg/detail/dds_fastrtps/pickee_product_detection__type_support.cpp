...
#include "shopee_interfaces/msg/detail/pickee_product_detection__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const shopee_interfaces::msg::PickeeProductDetection & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  shopee_interfaces::msg::PickeeProductDetection & ros_message)
{
  // Member: robot_id
  cdr >> ros_message.robot_id;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_shopee_interfaces
max_serialized_size_PickeeProductDetection(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = shopee_interfaces::msg::PickeeProductDetection;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_shopee_interfaces
max_serialized_size_key_PickeeProductDetection(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const shopee_interfaces::msg::PickeeProductDetection *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<shopee_interfaces::msg::PickeeProductDetection *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _PickeeProductDetection__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const shopee_interfaces::msg::PickeeProductDetection *>(
...
static size_t _PickeeProductDetection__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_PickeeProductDetection(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _PickeeProductDetection__callbacks = {
...
static rosidl_message_type_support_t _PickeeProductDetection__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_PickeeProductDetection__callbacks,
...
{
  return &shopee_interfaces::msg::typesupport_fastrtps_cpp::_PickeeProductDetection__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, shopee_interfaces, msg, PickeeProductDetection)() {
  return &shopee_interfaces::msg::typesupport_fastrtps_cpp::_PickeeProductDetection__handle;
}
