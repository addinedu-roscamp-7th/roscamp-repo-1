...
#include "shopee_interfaces/msg/detail/pickee_detected_product__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const shopee_interfaces::msg::PickeeDetectedProduct & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  shopee_interfaces::msg::PickeeDetectedProduct & ros_message)
{
  // Member: product_id
  cdr >> ros_message.product_id;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = shopee_interfaces::msg::PickeeDetectedProduct;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const shopee_interfaces::msg::PickeeDetectedProduct *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<shopee_interfaces::msg::PickeeDetectedProduct *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _PickeeDetectedProduct__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const shopee_interfaces::msg::PickeeDetectedProduct *>(
...
static size_t _PickeeDetectedProduct__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_PickeeDetectedProduct(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _PickeeDetectedProduct__callbacks = {
...
static rosidl_message_type_support_t _PickeeDetectedProduct__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_PickeeDetectedProduct__callbacks,
...
{
  return &shopee_interfaces::msg::typesupport_fastrtps_cpp::_PickeeDetectedProduct__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, shopee_interfaces, msg, PickeeDetectedProduct)() {
  return &shopee_interfaces::msg::typesupport_fastrtps_cpp::_PickeeDetectedProduct__handle;
}
