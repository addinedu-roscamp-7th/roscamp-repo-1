...
#include "shopee_interfaces/msg/detail/b_box__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const shopee_interfaces::msg::BBox & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  shopee_interfaces::msg::BBox & ros_message)
{
  // Member: x1
  cdr >> ros_message.x1;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = shopee_interfaces::msg::BBox;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const shopee_interfaces::msg::BBox *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<shopee_interfaces::msg::BBox *>(
    untyped_ros_message);
...
{
  return &shopee_interfaces::msg::typesupport_fastrtps_cpp::_BBox__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, shopee_interfaces, msg, BBox)() {
  return &shopee_interfaces::msg::typesupport_fastrtps_cpp::_BBox__handle;
}
