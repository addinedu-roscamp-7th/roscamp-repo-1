...
#include "shopee_interfaces/msg/detail/pose2_d__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const shopee_interfaces::msg::Pose2D & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  shopee_interfaces::msg::Pose2D & ros_message)
{
  // Member: x
  cdr >> ros_message.x;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = shopee_interfaces::msg::Pose2D;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const shopee_interfaces::msg::Pose2D *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<shopee_interfaces::msg::Pose2D *>(
    untyped_ros_message);
...
{
  return &shopee_interfaces::msg::typesupport_fastrtps_cpp::_Pose2D__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, shopee_interfaces, msg, Pose2D)() {
  return &shopee_interfaces::msg::typesupport_fastrtps_cpp::_Pose2D__handle;
}
