...
static const _PickeeVisionDetection_type_support_symbol_names_t _PickeeVisionDetection_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, shopee_interfaces, msg, PickeeVisionDetection)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, shopee_interfaces, msg, PickeeVisionDetection)),
  }
};
...
{
  return &::shopee_interfaces::msg::rosidl_typesupport_cpp::PickeeVisionDetection_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, shopee_interfaces, msg, PickeeVisionDetection)() {
  return get_message_type_support_handle<shopee_interfaces::msg::PickeeVisionDetection>();
}
