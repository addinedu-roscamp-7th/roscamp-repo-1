...
static const _PackeePackingComplete_type_support_symbol_names_t _PackeePackingComplete_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, shopee_interfaces, msg, PackeePackingComplete)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, shopee_interfaces, msg, PackeePackingComplete)),
  }
};
...
{
  return &::shopee_interfaces::msg::rosidl_typesupport_cpp::PackeePackingComplete_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, shopee_interfaces, msg, PackeePackingComplete)() {
  return get_message_type_support_handle<shopee_interfaces::msg::PackeePackingComplete>();
}
