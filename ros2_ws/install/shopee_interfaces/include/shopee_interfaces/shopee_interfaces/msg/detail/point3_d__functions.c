...
shopee_interfaces__msg__Point3D__create(void)
{
  ...
  shopee_interfaces__msg__Point3D * msg = (shopee_interfaces__msg__Point3D *)allocator.allocate(sizeof(shopee_interfaces__msg__Point3D), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(shopee_interfaces__msg__Point3D));
  bool success = shopee_interfaces__msg__Point3D__init(msg);
  if (!success) {
...
shopee_interfaces__msg__Point3D__destroy(shopee_interfaces__msg__Point3D * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    shopee_interfaces__msg__Point3D__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
shopee_interfaces__msg__Point3D__Sequence__init(shopee_interfaces__msg__Point3D__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  shopee_interfaces__msg__Point3D * data = NULL;

  if (size) {
    data = (shopee_interfaces__msg__Point3D *)allocator.zero_allocate(size, sizeof(shopee_interfaces__msg__Point3D), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = shopee_interfaces__msg__Point3D__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        shopee_interfaces__msg__Point3D__fini(&data[i - 1]);
      }
...
shopee_interfaces__msg__Point3D__Sequence__fini(shopee_interfaces__msg__Point3D__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      shopee_interfaces__msg__Point3D__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  shopee_interfaces__msg__Point3D__Sequence * array = (shopee_interfaces__msg__Point3D__Sequence *)allocator.allocate(sizeof(shopee_interfaces__msg__Point3D__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = shopee_interfaces__msg__Point3D__Sequence__init(array, size);
  if (!success) {
...
shopee_interfaces__msg__Point3D__Sequence__destroy(shopee_interfaces__msg__Point3D__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    shopee_interfaces__msg__Point3D__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
shopee_interfaces__msg__Point3D__Sequence__are_equal(const shopee_interfaces__msg__Point3D__Sequence * lhs, const shopee_interfaces__msg__Point3D__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!shopee_interfaces__msg__Point3D__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  shopee_interfaces__msg__Point3D__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(shopee_interfaces__msg__Point3D);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    shopee_interfaces__msg__Point3D * data =
      (shopee_interfaces__msg__Point3D *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!shopee_interfaces__msg__Point3D__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          shopee_interfaces__msg__Point3D__fini(&output->data[i]);
        }
        return false;
      }
    }
