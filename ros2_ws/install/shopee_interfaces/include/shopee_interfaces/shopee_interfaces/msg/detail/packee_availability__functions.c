...
shopee_interfaces__msg__PackeeAvailability__init(shopee_interfaces__msg__PackeeAvailability * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->message)) {
    shopee_interfaces__msg__PackeeAvailability__fini(msg);
    return false;
  }
  return true;
}
...
shopee_interfaces__msg__PackeeAvailability__are_equal(const shopee_interfaces__msg__PackeeAvailability * lhs, const shopee_interfaces__msg__PackeeAvailability * rhs)
{
  ...
  // cart_detected
  if (lhs->cart_detected != rhs->cart_detected) {
    return false;
  }
  // message
  ...
  shopee_interfaces__msg__PackeeAvailability * output)
{
  ...
  // cart_detected
  output->cart_detected = input->cart_detected;
  // message
...
shopee_interfaces__msg__PackeeAvailability__create(void)
{
  ...
  shopee_interfaces__msg__PackeeAvailability * msg = (shopee_interfaces__msg__PackeeAvailability *)allocator.allocate(sizeof(shopee_interfaces__msg__PackeeAvailability), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(shopee_interfaces__msg__PackeeAvailability));
  bool success = shopee_interfaces__msg__PackeeAvailability__init(msg);
  if (!success) {
...
shopee_interfaces__msg__PackeeAvailability__Sequence__init(shopee_interfaces__msg__PackeeAvailability__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  shopee_interfaces__msg__PackeeAvailability * data = NULL;

  if (size) {
    data = (shopee_interfaces__msg__PackeeAvailability *)allocator.zero_allocate(size, sizeof(shopee_interfaces__msg__PackeeAvailability), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = shopee_interfaces__msg__PackeeAvailability__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        shopee_interfaces__msg__PackeeAvailability__fini(&data[i - 1]);
      }
...
shopee_interfaces__msg__PackeeAvailability__Sequence__fini(shopee_interfaces__msg__PackeeAvailability__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      shopee_interfaces__msg__PackeeAvailability__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  shopee_interfaces__msg__PackeeAvailability__Sequence * array = (shopee_interfaces__msg__PackeeAvailability__Sequence *)allocator.allocate(sizeof(shopee_interfaces__msg__PackeeAvailability__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = shopee_interfaces__msg__PackeeAvailability__Sequence__init(array, size);
  if (!success) {
...
shopee_interfaces__msg__PackeeAvailability__Sequence__destroy(shopee_interfaces__msg__PackeeAvailability__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    shopee_interfaces__msg__PackeeAvailability__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
shopee_interfaces__msg__PackeeAvailability__Sequence__are_equal(const shopee_interfaces__msg__PackeeAvailability__Sequence * lhs, const shopee_interfaces__msg__PackeeAvailability__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!shopee_interfaces__msg__PackeeAvailability__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  shopee_interfaces__msg__PackeeAvailability__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(shopee_interfaces__msg__PackeeAvailability);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    shopee_interfaces__msg__PackeeAvailability * data =
      (shopee_interfaces__msg__PackeeAvailability *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!shopee_interfaces__msg__PackeeAvailability__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          shopee_interfaces__msg__PackeeAvailability__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!shopee_interfaces__msg__PackeeAvailability__copy(
