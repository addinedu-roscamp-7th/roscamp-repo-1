...
{
  new (message_memory) shopee_interfaces::msg::Point3D(_init);
}

void Point3D_fini_function(void * message_memory)
{
  auto typed_message = static_cast<shopee_interfaces::msg::Point3D *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Point3D_message_member_array[3] = {
  {
    ...
    offsetof(shopee_interfaces::msg::Point3D, x),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(shopee_interfaces::msg::Point3D, y),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(shopee_interfaces::msg::Point3D, z),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Point3D_message_members = {
  ...
  3,  // number of fields
  sizeof(shopee_interfaces::msg::Point3D),
...
get_message_type_support_handle<shopee_interfaces::msg::Point3D>()
{
  return &::shopee_interfaces::msg::rosidl_typesupport_introspection_cpp::Point3D_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, shopee_interfaces, msg, Point3D)() {
  return &::shopee_interfaces::msg::rosidl_typesupport_introspection_cpp::Point3D_message_type_support_handle;
}
