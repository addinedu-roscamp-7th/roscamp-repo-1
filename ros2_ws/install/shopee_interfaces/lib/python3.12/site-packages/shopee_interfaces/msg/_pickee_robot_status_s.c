...
bool shopee_interfaces__msg__pickee_robot_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("shopee_interfaces.msg._pickee_robot_status.PickeeRobotStatus", full_classname_dest, 60) == 0);
  }
  shopee_interfaces__msg__PickeeRobotStatus * ros_message = _ros_message;
  {  // robot_id
  ...
  {  // orientation_z
    ...
    assert(PyFloat_Check(field));
    ros_message->orientation_z = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
...
{
  /* NOTE(esteve): Call constructor of PickeeRobotStatus */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("shopee_interfaces.msg._pickee_robot_status");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "PickeeRobotStatus");
