...
class Metaclass_Obstacle(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from shopee_interfaces.msg import Vector2D
            if Vector2D.__class__._TYPE_SUPPORT is None:
                Vector2D.__class__.__import_type_support__()
...
class Obstacle(metaclass=Metaclass_Obstacle):
    ...
    _fields_and_field_types = {
        ...
        'position': 'shopee_interfaces/Point2D',
        'distance': 'float',
        'velocity': 'float',
        'direction': 'shopee_interfaces/Vector2D',
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BasicType('float'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['shopee_interfaces', 'msg'], 'Vector2D'),  # noqa: E501
    ...
    def __init__(self, **kwargs):
        ...
        self.obstacle_type = kwargs.get('obstacle_type', str())
        from shopee_interfaces.msg import Point2D
        self.position = kwargs.get('position', Point2D())
        self.distance = kwargs.get('distance', float())
        self.velocity = kwargs.get('velocity', float())
        from shopee_interfaces.msg import Vector2D
        self.direction = kwargs.get('direction', Vector2D())
        from shopee_interfaces.msg import BBox
    ...
    def obstacle_type(self, value):
        if self._check_fields:
            assert \
                ...
                "The 'obstacle_type' field must be of type 'str'"
    ...
    def direction(self, value):
        if self._check_fields:
            from shopee_interfaces.msg import Vector2D
            assert \
                isinstance(value, Vector2D), \
                "The 'direction' field must be a sub message of type 'Vector2D'"
