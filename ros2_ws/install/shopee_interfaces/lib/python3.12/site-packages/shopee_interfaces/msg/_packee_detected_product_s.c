...
bool shopee_interfaces__msg__packee_detected_product__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("shopee_interfaces.msg._packee_detected_product.PackeeDetectedProduct", full_classname_dest, 68) == 0);
  }
  shopee_interfaces__msg__PackeeDetectedProduct * ros_message = _ros_message;
  {  // product_id
  ...
  {  // position
    ...
    if (!shopee_interfaces__msg__point3_d__convert_from_py(field, &ros_message->position)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
{
  /* NOTE(esteve): Call constructor of PackeeDetectedProduct */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("shopee_interfaces.msg._packee_detected_product");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "PackeeDetectedProduct");
  ...
  {  // position
    PyObject * field = NULL;
    field = shopee_interfaces__msg__point3_d__convert_to_py(&ros_message->position);
    if (!field) {
      return NULL;
    }
    {
