#!/usr/bin/env python3
"""
SC_01_3 - 주문 생성 시나리오 실행 스크립트
"""
import argparse
import asyncio
import json

from shopee_main_service.scenario_suite import run_sc_01_3_order_create


def parse_args() -> argparse.Namespace:
    """명령행 인자를 파싱합니다."""
    parser = argparse.ArgumentParser(description='SC_01_3 주문 생성 시나리오 실행기')
