...
from shopee_main_service.database_models import Product, Section, Warehouse, Location, Shelf
from shopee_main_service.inventory_service import InventoryService
