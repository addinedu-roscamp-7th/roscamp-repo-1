...
from shopee_main_service.streaming_service import StreamingService, UdpRelayProtocol
...
class TestUdpRelayProtocol:
    ...
    def test_error_received(self):
        ...
        # Act (예외 발생하지 않음)
        with patch('shopee_main_service.streaming_service.logger') as mock_logger:
