...
class MobileController(Node):
    ...
    def publish_arrival(self, move_status):
        ...
        arrival_msg.robot_id = 99
        arrival_msg.order_id = 99
        arrival_msg.location_id = 99
        arrival_msg.final_pose = Pose2D()
        arrival_msg.final_pose.x = 99.0
        arrival_msg.final_pose.y = 99.0
        arrival_msg.final_pose.theta = 99.0
