...
-- Shelf A (과일/스프레드)
('8801234567001', '사과', 50, 3000, 0, '과일', 1, TRUE, 1, 3),
('8801234567002', '바나나', 30, 2000, 10, '과일', 1, TRUE, 2, 3),
('8801234567003', '유기농 사과', 20, 5000, 0, '과일', 1, TRUE, 1, 3),
('8801234567010', '땅콩버터', 25, 4500, 0, '스프레드', 2, TRUE, 3, 1),

-- Shelf B (채소/신선식품)
('8801234567004', '양상추', 40, 2500, 0, '채소', 1, TRUE, 5, 3),
('8801234567005', '토마토', 35, 3500, 5, '채소', 1, TRUE, 6, 3),
('8801234567011', '계란', 100, 5000, 0, '신선식품', 8, FALSE, 7, 3),
('8801234567012', '새우', 20, 12000, 15, '해산물', 4, FALSE, 7, 2),

-- Shelf C (음료/베이커리)
('8801234567006', '사과주스', 60, 1500, 0, '음료', 1, TRUE, 9, 1),
('8801234567007', '우유', 45, 2500, 0, '음료', 3, FALSE, 10, 2),
('8801234567008', '두유', 40, 2300, 0, '음료', 5, TRUE, 10, 2),
('8801234567009', '아몬드우유', 35, 2800, 0, '음료', 9, TRUE, 10, 2),
('8801234567013', '식빵', 30, 3500, 0, '베이커리', 7, FALSE, 11, 1);
