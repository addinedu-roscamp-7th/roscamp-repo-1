...
from main_service.robot_coordinator import RobotCoordinator
from main_service.constants import RobotType, RobotStatus
...
def robot_coordinator(mock_state_store: MagicMock, mock_event_bus: MagicMock) -> RobotCoordinator:
    ...
    with patch('main_service.robot_coordinator.settings') as mock_settings:
