...
UI_FILES = {
    ...
    MODULE_ROOT / 'ui' / 'promoded_class.ui': MODULE_ROOT / 'ui_gen' / 'promoded_class.py',
...
def build_ui(
    src=MODULE_ROOT / 'ui' / 'main_window.ui', dest=MODULE_ROOT / 'ui_gen' / 'main_window.py'
):
...
def start_app():
    ...
    return subprocess.Popen([sys.executable, '-m', 'shopee_app.launcher'], cwd=str(ROOT))
