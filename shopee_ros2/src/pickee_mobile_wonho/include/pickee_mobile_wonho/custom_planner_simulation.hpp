...
namespace custom_planner_simulation
{
    ...
    class CustomPlannerSimulation : public nav2_core::GlobalPlanner
    {
    public:
        CustomPlannerSimulation();
        ~CustomPlannerSimulation() = default;
    ...
    private:
        ...
        std::string name_;
        rclcpp::Logger logger_{rclcpp::get_logger("CustomPlannerSimulation")};
